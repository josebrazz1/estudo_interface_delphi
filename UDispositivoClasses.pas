...
begin
  Self.FPortatil := Value;
end;

{ TPc }

function TPc.GetEspacoDisco: Integer;
begin
  Result := Self.FEspacoDisco;
end;

function TPc.GetMemRam: Integer;
begin
  Result := Self.FMemRam;
end;

function TPc.GetMemVideo: Integer;
begin
  Result := Self.MemVideo;
end;

procedure TPc.SetEspacoDisco(const Value: Integer);
begin
  Self.FEspacoDisco := Value;
end;

procedure TPc.SetMemRam(const Value: Integer);
begin
  Self.FMemRam := Value;
end;

procedure TPc.SetMemVideo(const Value: Integer);
begin
  Self.FMemVideo := Value;
end;
